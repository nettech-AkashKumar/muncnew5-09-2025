    ...
    >
      ...
      <div style={{ marginTop: '5px', overflowY: 'auto', height: '80vh', borderRadius: '8px', backgroundColor: 'white' }}>
        {!user ? (
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '40px',height:'79vh' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '60px 20px', textAlign: 'center', color: '#6c757d',height:'79vh' }}>
            <FaBell style={{ fontSize: '48px', color: '#dee2e6', marginBottom: '16px' }} />
